...
#ifndef FMCDAC_AWG_RELEASE_PROFILE
#define FMCDAC_AWG_RELEASE_PROFILE 0
#endif

#ifndef FMCDAC_AWG_LEGACY_INGRESS_MAINTENANCE
#if FMCDAC_AWG_RELEASE_PROFILE
#define FMCDAC_AWG_LEGACY_INGRESS_MAINTENANCE 0
#else
...
#if FMCDAC_AWG_RELEASE_PROFILE && \
	(!FMCDAC_AWG_SCHED_ETH || !FMCDAC_AWG_SCHED_DMA_REFILL || \
	 !FMCDAC_AWG_SCHED_STREAM)
#error "scheduler-eth-release requires UDP RX DMA, DDR staging, and scheduler DMA"
#endif
