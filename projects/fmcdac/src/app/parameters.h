...
#define AWG_ETH_DMA_BUFFER_BYTES                9216U
...
#define AWG_PHASE_E_EXTENSION_BASEADDR          0x44AE0000U
...
#define AWG_SCHED_DMA_BASEADDR                  XPAR_AXI_SCHED_DMA_BASEADDR
    ...
    !defined(XPAR_AWG_EXTENSION_0_BASEADDR)
#error "Phase F Ethernet XPAR bases are missing from the licensed XSA"
    ...
    XPAR_AWG_EXTENSION_0_BASEADDR != AWG_PHASE_E_EXTENSION_BASEADDR
...
#if defined(FMCDAC_AWG_EXTENSION_BASEADDR) && \
    FMCDAC_AWG_EXTENSION_BASEADDR != XPAR_AWG_EXTENSION_0_BASEADDR
#error "FMCDAC AWGX base override disagrees with generated XPAR"
#endif
#define AWG_EXTENSION_BASEADDR                  XPAR_AWG_EXTENSION_0_BASEADDR
#endif
