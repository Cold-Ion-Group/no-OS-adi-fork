...
{
   static XIntc intc;
   static XAxiEthernet axi_ethernet_0_AxiEthernet;
   static XAxiDma  axi_ethernet_0_AxiDma;
...
while(1)
...

   {
      ...
      print("\r\nRunning AxiEthernetSgDmaIntrExample() for axi_ethernet_0...\r\n");

      Status = AxiEthernetSgDmaIntrExample(&intc, &axi_ethernet_0_AxiEthernet,
                     &axi_ethernet_0_AxiDma,
                     XPAR_AXI_ETHERNET_0_DEVICE_ID,
                     XPAR_AXI_ETHERNET_0_DMA_DEVICE_ID,
                     XPAR_MICROBLAZE_0_AXI_INTC_AXI_ETHERNET_0_INTERRUPT_INTR,
