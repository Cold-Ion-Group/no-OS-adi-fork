...
# Path of this script: C:\Users\fpga_\Desktop\adi\no-OS\projects\plain_spi\no-os_system\_ide\scripts\systemdebugger_no-os_system_standalone.tcl
# 
# 
# Usage with xsct:
...
fpga -file C:/Users/fpga_/Desktop/adi/no-OS/projects/plain_spi/no-os/_ide/bitstream/mb_preset_wrapper.bit
...
after 3000
targets -set -nocase -filter {name =~ "*microblaze*#0" && bscan=="USER2" }
dow C:/Users/fpga_/Desktop/adi/no-OS/projects/plain_spi/no-os/Debug/no-os.elf
targets -set -nocase -filter {name =~ "*microblaze*#0" && bscan=="USER2" }
con
